 ...
 */
final class Version20250706181629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cliente (id INT AUTO_INCREMENT NOT NULL, contacto VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE peluquero (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reserva (id INT AUTO_INCREMENT NOT NULL, peluquero_id INT NOT NULL, cliente_id INT NOT NULL, servicio_id INT NOT NULL, pelu_id INT DEFAULT NULL, fecha_hora DATETIME NOT NULL, estado VARCHAR(100) NOT NULL, INDEX IDX_188D2E3BF037A736 (peluquero_id), INDEX IDX_188D2E3BDE734E51 (cliente_id), INDEX IDX_188D2E3B71CAA3E7 (servicio_id), INDEX IDX_188D2E3BB01E477C (pelu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nombre VARCHAR(100) NOT NULL, apellido VARCHAR(100) NOT NULL, rol VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reserva ADD CONSTRAINT FK_188D2E3BB01E477C FOREIGN KEY (pelu_id) REFERENCES peluquero (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserva DROP FOREIGN KEY FK_188D2E3BB01E477C');
